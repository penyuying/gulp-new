...
//            sub[taskName].parts = new build.teemoGulp(taskName);
            ...
            //启动测试工具
            gulp.task(taskName + "_testArr", sub[taskName].testArr, function () {
...
//                console.log(sub[taskName].taskArr)
	...
	//"test"启动测试工具
    gulp.task("testArr", testArr, function () {
    ...
    gulp.task('default', ["ifobj"], function () {
