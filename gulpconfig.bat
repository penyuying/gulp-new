@echo off
	...
	echo "第十组测试工具完成"
	call npm install --save-dev %localmod%gulp-fileTime %localmod%gulp-jsontpls %localmod%gulp-tpls %localmod%remove-plugin %localmod%gulp-loadobj %localmod%gulp-connect-multi %localmod%gulp-htmlmin  %localmod%gulp-rev %localmod%gulp-rev-collector %localmod%gulp-encrypt %localmod%gulp-jsencrypt
	rem call npm install --save-dev /mnt/userModules/gulp-fileTime /mnt/userModules/gulp-jsontpls /mnt/userModules/gulp-tpls /mnt/userModules/remove-plugin /mnt/userModules/gulp-loadobj /mnt/userModules/gulp-connect-multi /mnt/userModules/gulp-htmlmin  /mnt/userModules/gulp-rev   /mnt/userModules/gulp-rev-collector /mnt/userModules/gulp-encrypt /mnt/userModules/gulp-jsencrypt
	echo "第十一组安装本地插件完成"
:exit